...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(7), __webpack_require__(22)(module)))
...
// CONCATENATED MODULE: ./app/javascript/frontend/util/marker_manager.js
...
// CONCATENATED MODULE: ./app/javascript/frontend/components/Map.js
...
// CONCATENATED MODULE: ./app/javascript/frontend/util/product_api_util.js

var product_api_util_getAllProducts = function getAllProducts() {
...
var product_api_util_getProductsByDept = function getProductsByDept(deptNo) {
  return jquery_default.a.ajax({
    method: 'GET',
    url: "/api/products/department?department_id=".concat(deptNo),
    error: function error(err) {
      return console.log(err);
    }
  });
};
var product_api_util_createProduct = function createProduct(product) {
  return jquery_default.a.ajax({
    method: 'POST',
...
// CONCATENATED MODULE: ./app/javascript/frontend/actions/product_actions.js

var GET_ALL_PRODUCTS_ACTION = 'GET_ALL_PRODUCTS_ACTION';
var GET_PRODUCTS_BY_DEPT_ACTION = 'GET_PRODUCTS_BY_DEPT_ACTION';
var RECEIVE_CREATED_PRODUCT_ACTION = 'RECEIVE_CREATED_PRODUCT_ACTION'; // Redux Thunk Action Get All Products

var product_actions_getAllProductsThunk = function getAllProductsThunk() {
  return function (dispatch) {
    return product_api_util_getAllProducts().then(function (products) {
...
var product_actions_getProductsByDeptThunk = function getProductsByDeptThunk(no) {
  return function (dispatch) {
    return product_api_util_getProductsByDept(no).then(function (products) {
      return dispatch(receiveProductsByDept(products));
    });
  };
}; // Products by department

var receiveProductsByDept = function receiveProductsByDept(products) {
  return {
...
var product_actions_createProductThunk = function createProductThunk(product) {
  return function (dispatch) {
    return product_api_util_createProduct(product).then(function (product) {
      return dispatch(receiveCreatedProduct(product));
    });
  };
}; // Private receive created product

var receiveCreatedProduct = function receiveCreatedProduct(data) {
  return {
    type: RECEIVE_CREATED_PRODUCT_ACTION,
    data: data
  };
};
// CONCATENATED MODULE: ./app/javascript/frontend/components/products/product_home.js
function product_home_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { product_home_typeof = function _typeof(obj) { return typeof obj; }; } else { product_home_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return product_home_typeof(obj); }
...
function product_home_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function product_home_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function product_home_createClass(Constructor, protoProps, staticProps) { if (protoProps) product_home_defineProperties(Constructor.prototype, protoProps); if (staticProps) product_home_defineProperties(Constructor, staticProps); return Constructor; }

function product_home_possibleConstructorReturn(self, call) { if (call && (product_home_typeof(call) === "object" || typeof call === "function")) { return call; } return product_home_assertThisInitialized(self); }

function product_home_getPrototypeOf(o) { product_home_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return product_home_getPrototypeOf(o); }

function product_home_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function product_home_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) product_home_setPrototypeOf(subClass, superClass); }

function product_home_setPrototypeOf(o, p) { product_home_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return product_home_setPrototypeOf(o, p); }
...
var product_home_App =
/*#__PURE__*/
function (_React$Component) {
  product_home_inherits(App, _React$Component);

  function App(props) {
    var _this;

    product_home_classCallCheck(this, App);

    _this = product_home_possibleConstructorReturn(this, product_home_getPrototypeOf(App).call(this, props));
    _this.state = {
      array: [],
      first: false,
      name: '',
    ...
    _this.update = _this.update.bind(product_home_assertThisInitialized(_this));
    _this.handleCreate = _this.handleCreate.bind(product_home_assertThisInitialized(_this));
    return _this;
  }

  product_home_createClass(App, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        ...
        className: "header"
      }, " "), react_default.a.createElement(components_Map, null), react_default.a.createElement("div", {
        className: "search-bar"
      }), react_default.a.createElement("div", {
        className: "products-categories"
      }, react_default.a.createElement("h4", null, "  Main Categoriesopopo ")), react_default.a.createElement("div", {
...
var product_home_mapStateToProps = function mapStateToProps(state) {
  return {
    products: state.products
  };
};

var product_home_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    getAllProducts: function getAllProducts() {
      return dispatch(product_actions_getAllProductsThunk());
    },
    createProduct: function createProduct(productInfo) {
      return dispatch(product_actions_createProductThunk(productInfo));
    }
  };
};

/* harmony default export */ var product_home = (connect_connect(product_home_mapStateToProps, product_home_mapDispatchToProps)(product_home_App));
// CONCATENATED MODULE: ./app/javascript/frontend/components/products/Fruits.js
function Fruits_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { Fruits_typeof = function _typeof(obj) { return typeof obj; }; } else { Fruits_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return Fruits_typeof(obj); }

function Fruits_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function Fruits_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function Fruits_createClass(Constructor, protoProps, staticProps) { if (protoProps) Fruits_defineProperties(Constructor.prototype, protoProps); if (staticProps) Fruits_defineProperties(Constructor, staticProps); return Constructor; }

function Fruits_possibleConstructorReturn(self, call) { if (call && (Fruits_typeof(call) === "object" || typeof call === "function")) { return call; } return Fruits_assertThisInitialized(self); }

function Fruits_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function Fruits_getPrototypeOf(o) { Fruits_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return Fruits_getPrototypeOf(o); }

function Fruits_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) Fruits_setPrototypeOf(subClass, superClass); }

function Fruits_setPrototypeOf(o, p) { Fruits_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return Fruits_setPrototypeOf(o, p); }
...
/*#__PURE__*/
function (_React$Component) {
  Fruits_inherits(Fruits, _React$Component);

  function Fruits(props) {
    var _this;

    Fruits_classCallCheck(this, Fruits);

    _this = Fruits_possibleConstructorReturn(this, Fruits_getPrototypeOf(Fruits).call(this, props));
    _this.state = {
      products: []
    };
    return _this;
  ...
  Fruits_createClass(Fruits, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        ...
        className: "header"
      }, " Fruits  "), react_default.a.createElement("div", {
        ...
        }, product.name.capitalize())), react_default.a.createElement("button", {
...
var Fruits_mapStateToProps = function mapStateToProps(state) {
  return {
    productsByDept: state.products.productsByDept
  };
};

var Fruits_mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    getProductsByDept: function getProductsByDept(no) {
      return dispatch(product_actions_getProductsByDeptThunk(no));
    }
  };
};

/* harmony default export */ var products_Fruits = (connect_connect(Fruits_mapStateToProps, Fruits_mapDispatchToProps)(Fruits_Fruits));
// CONCATENATED MODULE: ./app/javascript/frontend/components/products/products_by_dept.js
function products_by_dept_typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { products_by_dept_typeof = function _typeof(obj) { return typeof obj; }; } else { products_by_dept_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return products_by_dept_typeof(obj); }

function products_by_dept_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function products_by_dept_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function products_by_dept_createClass(Constructor, protoProps, staticProps) { if (protoProps) products_by_dept_defineProperties(Constructor.prototype, protoProps); if (staticProps) products_by_dept_defineProperties(Constructor, staticProps); return Constructor; }

function products_by_dept_possibleConstructorReturn(self, call) { if (call && (products_by_dept_typeof(call) === "object" || typeof call === "function")) { return call; } return products_by_dept_assertThisInitialized(self); }

function products_by_dept_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function products_by_dept_getPrototypeOf(o) { products_by_dept_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return products_by_dept_getPrototypeOf(o); }

function products_by_dept_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) products_by_dept_setPrototypeOf(subClass, superClass); }

function products_by_dept_setPrototypeOf(o, p) { products_by_dept_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return products_by_dept_setPrototypeOf(o, p); }
...
var products_by_dept_ProductsByDepartment =
/*#__PURE__*/
function (_React$Component) {
  products_by_dept_inherits(ProductsByDepartment, _React$Component);

  function ProductsByDepartment(props) {
    var _this;

    products_by_dept_classCallCheck(this, ProductsByDepartment);

    _this = products_by_dept_possibleConstructorReturn(this, products_by_dept_getPrototypeOf(ProductsByDepartment).call(this, props));
    _this.state = {};
    return _this;
  } //    update(field) {
  ...
  products_by_dept_createClass(ProductsByDepartment, [{
    key: "renderDepartment",
    value: function renderDepartment() {
      var params = this.props.match.params.department;

      switch (params) {
        case 'fruits':
          {
            return react_default.a.createElement(products_Fruits, null);
          }
        ...
        default:
          return react_default.a.createElement("p", null, "All departments");
      }
    }
  }, {
    key: "render",
...
var products_by_dept_mapStateToProps = function mapStateToProps(state) {
  return {//    products: state.products
  };
};

var products_by_dept_mapDispatchToProps = function mapDispatchToProps(dispatch) {
...
/* harmony default export */ var products_by_dept = (connect_connect(products_by_dept_mapStateToProps, products_by_dept_mapDispatchToProps)(withRouter(products_by_dept_ProductsByDepartment)));
// CONCATENATED MODULE: ./app/javascript/frontend/components/App.js
...
// CONCATENATED MODULE: ./app/javascript/frontend/components/root.js
...
var root_Root = function Root(_ref) {
  var store = _ref.store;
  return react_default.a.createElement(components_Provider, {
    store: store
  }, react_default.a.createElement(react_router_dom_HashRouter, null, react_default.a.createElement(components_App, null)));
};

/* harmony default export */ var components_root = (root_Root);
// CONCATENATED MODULE: ./app/javascript/frontend/reducers/products/products_by_dept_reducer.js

/* harmony default export */ var products_by_dept_reducer = (function () {
...
// CONCATENATED MODULE: ./app/javascript/frontend/reducers/products/all_products_reducer.js

/* harmony default export */ var all_products_reducer = (function () {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var action = arguments.length > 1 ? arguments[1] : undefined;
  Object.freeze(state);
...
// CONCATENATED MODULE: ./app/javascript/frontend/reducers/products_reducer.js



/* harmony default export */ var products_reducer = (combineReducers({
  productsByDept: products_by_dept_reducer,
  allProducts: all_products_reducer
}));
// CONCATENATED MODULE: ./app/javascript/frontend/reducers/root_reducer.js


/* harmony default export */ var root_reducer = (combineReducers({
...
var redux_logger = __webpack_require__(14);
var redux_logger_default = /*#__PURE__*/__webpack_require__.n(redux_logger);

// CONCATENATED MODULE: ./app/javascript/frontend/store/store.js
...
var store_configureStore = function configureStore() {
  ...
  return createStore(root_reducer, preloadedState, // Preloaded state is the initial state
  applyMiddleware(redux_thunk_es, redux_logger_default.a));
};

/* harmony default export */ var store_store = (store_configureStore);
// CONCATENATED MODULE: ./app/javascript/frontend/index.js
